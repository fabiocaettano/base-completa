Você é um especialista em python e precisa criar uma solução para poular a coluna "formato_json" do dicionário dict_pedidos_unicos.
Todos os dicionários compartilham o mesmo key para facilitar a leitura dos dados.
A ideia é percorrer o dicionario "dict_pedidos_unicos" e montar uma estrutura json que deverá ser armazenada na coluna formato_json.


Segue os dicionários:

1. Dicionário dict_pedidos_novos:
defaultdict(<class 'list'>, {'0042405325262nk': [{'item': 115600469, 'desc_item': 'FECHA MALAS VERMELHO (21 60mm)', 'un_medida': 'SC', 'qtd_total': 120}, {'item': 765000890, 'desc_item': 'ENVELOPE FRONHA 16CM X 9CM', 'un_medida': 'PA', 'qtd_total': 40}, {'item': 889800170, 'desc_item': 'ETIQUETA RESGATE TELESENA', 'un_medida': 'FL', 'qtd_total': 2}]})


2. Dicionário dict_pedidos_cancelados:
defaultdict(<class 'list'>, {'0042405325262nk': [{'item': 115600469, 'desc_item': 'FECHA MALAS VERMELHO (21 60mm)', 'un_medida': 'SC', 'qtd_total': 40}, {'item': 116001259, 'desc_item': 'FITA ADESIVA PLAST EMPACOTAM', 'un_medida': 'RO', 'qtd_total': 30}, {'item': 752402499, 'desc_item': 'ROTULO ALTERNATIVO S BANDEIRA', 'un_medida': 'PA', 'qtd_total': 40}]})


3. Dicionário dict_lotes_tratamento_iii:
defaultdict(<class 'list'>, {'0042405325262nk': [{'lote': 1432455, 'item': 116601566, 'descricao': 'CAIXA ENCOMENDA M', 'um': 'CX', 'qtd_total': 3}, {'lote': 1433057, 'item': 116601566, 'descricao': 'CAIXA ENCOMENDA M', 'um': 'CX', 'qtd_total': 2}]})      


4. Dicionário dict_pedios_com_pauta_impressa:
defaultdict(<class 'list'>, {'0042405325262nk': [{'lote': 1432900, 'item': 116601558, 'descricao': 'CAIXA ENCOMENDA P', 'um': 'CX', 'qtd_total': 1}, {'lote': 1470123, 'item': 116601558, 'descricao': 'CAIXA ENCOMENDA P', 'um': 'CX', 'qtd_total': 9}]})      


5. Dicionário dict_lotes_objetos_itens:
defaultdict(<class 'list'>, {'0042405325262nk': [{'nota_serie': 10302906.0, 'subpauta': '143245529013T4ZP06', 'zona': 'ZP06', 'item': 116601540, 'descricao': 'CAIXA ENCOMENDA G', 'um': 'CX', 'qtd_total': 1}, {'nota_serie': 10303006.0, 'subpauta': '143245529014T4ZP06', 'zona': 'ZP06', 'item': 116601540, 'descricao': 'CAIXA ENCOMENDA G', 'um': 'CX', 'qtd_total': 1}, {'nota_serie': 10303106.0, 'subpauta': '143245529015T4ZP06', 'zona': 'ZP06', 'item': 116601540, 'descricao': 'CAIXA ENCOMENDA G', 'um': 'CX', 'qtd_total': 1}, {'nota_serie': 85542402.0, 'subpauta': '1433129155011FMZM03', 'zona': 'ZM03', 'item': 752402030, 'descricao': 'AVISO RECEBIMENTO AR (CENTO)', 'um': 'PA', 'qtd_total': 10}, {'nota_serie': 85573702.0, 'subpauta': '1433368155011FMZM28', 'zona': 
'ZM28', 'item': 752460099, 'descricao': 'ETIQUETA FISICA ECON MARKET YD', 'um': 'FL', 'qtd_total': 100}, {'nota_serie': 85586502.0, 'subpauta': '1433380155011FMZM10', 'zona': 'ZM10', 'item': 115600370, 'descricao': 'SELO LACRE CAIXETA   SLC 01', 'um': 'SC', 'qtd_total': 40}]})


6. Dicionario df_lote_possui_objeto_unificar_rastreamento:
Criando dicionário de lotes com objetos postados unificados para rasteamento...
defaultdict(<class 'list'>, {'0042405325262nk': [{'lote': 1432455, 'nota_serie': 10302906.0, 'registro': 'PV068079848BR', 'data_expedicao': Timestamp('2025-10-02 00:00:00')}, {'lote': 1432455, 'nota_serie': 10303006.0, 'registro': 'PV068079896BR', 'data_expedicao': Timestamp('2025-10-02 00:00:00')}, {'lote': 1432455, 'nota_serie': 10303106.0, 'registro': 'PV068079940BR', 'data_expedicao': Timestamp('2025-10-02 00:00:00')}, {'lote': 1433129, 'nota_serie': 85542402.0, 'registro': 'PV068159223BR', 'data_expedicao': Timestamp('2025-10-24 00:00:00')}, {'lote': 1433368, 'nota_serie': 85573702.0, 'registro': 'PV068239828BR', 'data_expedicao': Timestamp('2025-10-31 00:00:00')}, {'lote': 1433380, 'nota_serie': 85586502.0, 'registro': 'PV068286350BR', 'data_expedicao': Timestamp('2025-11-04 00:00:00')}, {'lote': 1433380, 'nota_serie': 85586502.0, 'registro': 'PV068286363BR', 'data_expedicao': 
Timestamp('2025-11-04 00:00:00')}]})


7. Dicionario dict_pedido_unico:
defaultdict(<class 'list'>, {'0042405325262nk': [{'dt_trans': Timestamp('2025-10-17 00:00:00'), 'cliente': 16853397, 'nome_cli': 'AGF SANTAMARIENSE', 'mcu': '00424053', 'fomrato_json': '{}'}]})


A estrutura JSON possui 07 niveis, chave e valor.
O primeiro nivel é a chave "NUM_PEDIDO_SICAP" e recebe o valor key do dicionário dict_pedido_unico.
O segundo nivel possui a chave "PEDIDO" e os valor srão os dados do dicionário dict_pedidos_novos.
O terceiro nivel possui a chave "RESERVADO" e os valores serão os dados do dicionário dict_pedidos_novos.
O quarto nivel possui a chave "CANCELADO" e os valores serão do dicionário dict_pedidos_cancelados.
O quinto nivel possui a chave "PROCESSAMENTO" e os valores serão do dicionário dict_lotes_tratamento_iii.
O sexto nivel possui a chave "PAUTA_IMPRESSA" e os valores serão do dicionário dict_lotes_tratamento_i.
O sétimo nivel possui a chave "ATENDIDO" que recerá os valores NOTA_FISCAL e SUBPAUTA do dicionário dict_lotes_objetos_itens estes não se repetem, e a terceira chave será" ITEMS"
quer possui duas chaves "SKU" e "RASTREAMENTO", a chave "SKU" será preenchida pelo dicionário dict_lotes_objetos_itens, e a chave "RASTREAMENTO" será preenchida pelo dicionário df_lote_possui_objeto_unificar_rastreamento.
O sétimo nivel possui a NOTA FISCAL como divisor entre as chaves.


Segue a estrutura JSON:
{
	"NUM_PEDIDO_SISCAP" : dict_pedido_unicio["NUM_PEDIDO_SISCAP"],
	"PEDIDO" :{	
		"DT_TRANS" : dict_pedido_unico["DT_TRANS"],
		"MCU" : dict_pedido_unicio["mcu"],
		"CLIENTE" : dict_pedido_unico["cliente"],
		"NOME_CLI" : dict_pedido_unico["nome_cli"],
		"DESCRICAO_MCCO" : dict_pedido_unico["DESCRICAO_MCCO"]	
	},
	"RESERVADO" : [
		{
		  "ITEM" : dict_pedidos_novos["item"],
		  "DESCRICAO_ITEM" : dict_pedidos_novos["desc_item"],		
		  "UN_MEDIDA" : dict_pedidos_novos["un)medida"], 		'
	          "QTDE" : dict_pedidos_novos["qtde_total"],		
		},
		{	
		  "ITEM" : dict_pedidos_novos["item"],
		  "DESCRICAO_ITEM" : dict_pedidos_novos["desc_item"],		
	...
	"CANELADO" : [
		{
		  "ITEM" : dict_pedidos_cancelados["item"],
		  "DESCRICAO_ITEM" : dict_pedidos_cancelados["desc_item"],		
		  "UN_MEDIDA" : dict_pedidos_cancelados["un)medida"], 		
	          "QTDE" : dict_pedidos_cancelados["qtde_total"],		
		},
		{	
		  "ITEM" : dict_pedidos_cancelados["item"],
		  "DESCRICAO_ITEM" : dict_pedidos_cancelados["desc_item"],		
	...
	"PROCESSAMENTO" : [
		{
		  "ITEM" : dict_lotes_tratamento_iii["item"],
		  "DESCRICAO_ITEM" : dict_lotes_tratamento_iii["desc_item"],		
		  "UN_MEDIDA" : dict_lotes_tratamento_iii["un)medida"], 		
	          "QTDE" : dict_lotes_tratamento_iii["qtde_total"],		
		},
		{	
		  "ITEM" : dict_lotes_tratamento_iii["item"],
		  "DESCRICAO_ITEM" : dict_lotes_tratamento_iii["desc_item"],		
	...
	"PAUTA_IMPRESSA" : [
		{
		  "ITEM" : dict_lotes_tratamento_i["item"],
		  "DESCRICAO_ITEM" : dict_lotes_tratamento_i["desc_item"],		
		  "UN_MEDIDA" : dict_lotes_tratamento_i["un)medida"], 		
	          "QTDE" : dict_lotes_tratamento_i["qtde_total"],		
		},
		{		 
		  "ITEM" : dict_lotes_tratamento_i["item"],
		  "DESCRICAO_ITEM" : dict_lotes_tratamento_i["desc_item"],		
	...
	"ATENDIDO: {
		"NOTA_SERIE" : dict_lotes_objetos_itens["nota_serie],
		"ZONA" :  dict_lotes_objetos_itens["zona],
		"ITENS" : {
			  "SKU" : [			 	
					{
		 		  	        "ITEM" : dict_lotes_objetos_itens["item"],
	   		                        "DESCRICAO_ITEM" : dict_lotes_objetos_itens["desc_item"],		
		               	                "UN_MEDIDA" : dict_lotes_objetos_itens["un)medida"], 		
		                                "QTDE" : dict_lotes_objetos_itenss["qtde_total"],		
					},
					{	
				  		   "ITEM" : dict_lotes_objetos_itens["item"],
			                           "DESCRICAO_ITEM" : dict_lotes_objetos_itens["desc_item"],		
		       ...
		       "RASTREAMENTO" : [
						{
				                  "REGISTRO" : df_lote_possui_objeto_unificar_rastreamento["registro"]
						},
						{
						  "REGISTRO" : df_lote_possui_objeto_unificar_rastreamento["registro"]
						}	
...
Segue o código desenvolvido até o momento para criar os dicionários:
...
Implementar a etapa 05 E 06.
Criar um processamento para armazenar numa varável a estrutura JSON e atulizar a coluna "formato_json" do dicionário df_pedido_unico conforem o relacionamento com a chave key que representa o valor NUM_PEDIDO_SICAP.
